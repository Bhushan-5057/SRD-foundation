      ...
      <div className="grid gap-6 lg:grid-cols-2 lg:items-center">
        ...
        >
          ...
          {action ? (
            <Link
              href={action.href}
              className="mt-5 inline-flex rounded-full border border-[var(--border-color)] bg-[#507734] px-5 py-2.5 text-sm font-semibold text-white transition hover:scale-105"
            >
              {action.label}
            </Link>
          ) : null}
        ...
        <div
          className={`relative min-h-[220px] overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--surface)] ${reverse ? "lg:order-1" : ""
            }`}
